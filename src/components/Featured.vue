  ...
  <section id="course">
    ...
    >
      ...
      >
        ...
        <h1 class="text-xl font-semibold text-zinc-300 pb-3">Newest Course</h1>
      </header>
      ...
      >
        ...
        <div class="flex flex-col gap-3 px-3 py-12">
          ...
          <div class="flex items-center justify-between">
            ...
            <span
              class="px-2 py-1 text-zinc-300 font-semi-bold border-2 border-dashed border-zinc-700 rounded"
            >
              $2
            </span>
          </div>
